            ...
            <header className={styles.header}>
                ...
                <section className={styles.description}>
                    ...
                    <div className={styles.description__wrapper}>
                        ...
                        <p>As part of the collective's activities, besides participating in local events and promoting
                ...
                <div className={styles.body__wrapper}>
                    ...
                    <div className={styles.body__wrapper__text}>
                        ...
                        <p className={styles.body__wrapper__text__paragraph}>
                            Worked from the bottom-up to structure and design of what would be the IHGBI's new web page,
                        ...
                        <p className={styles.body__wrapper__text__paragraph}>
                            ...
                            product that would be able to portray the group's essence and meaning, while centralizing
